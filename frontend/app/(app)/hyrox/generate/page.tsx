            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex gap-1.5">
                  <button onClick={() => setSelectedEquipment(EQUIPMENT_OPTIONS.map(e => e.value))}
                    className="text-[11px] px-2 py-0.5 rounded border border-white/10 text-slate-400 hover:text-white hover:border-white/20 transition-all">
                    Tout
                  </button>
